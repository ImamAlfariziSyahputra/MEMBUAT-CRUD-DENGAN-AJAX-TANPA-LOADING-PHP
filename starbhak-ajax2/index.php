...
<body>
    <div class="table-responsive">
        <table id="data" class="table table-striped table-bordered" cellspacing="0" style="width:100%">
            <thead>
                <tr>
                    <td>No</td>
                    <td>Nama Siswa</td>
            ...
            <tbody>
                <?php 
                    include 'koneksi.php';
                    $no = 1;
                    $query = "SELECT * FROM tbl_siswa_search ORDER BY id DESC";
